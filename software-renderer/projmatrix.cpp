...
//[/comment]
void projmatrix::setProjectionMatrix(const float &angleOfView, const float &near, const float &far, Matrix44f &M)
{
    // do some work here
...
//[/comment]
void projmatrix::multPointMatrix(const Vec3f &in, Vec3f &out, const Matrix44f &M)
{
    //out = in * Mproj;
...
{
    uint32_t imageWidth = 520, imageHeight = 520;
    Matrix44f Mproj;
