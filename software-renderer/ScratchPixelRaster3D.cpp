...
ScratchPixelRaster3D::ScratchPixelRaster3D()
{
...
void ScratchPixelRaster3D::init(Screen *screen, Camera *camera, Mesh *mesh, float delta)
{
            ...
            for (uint32_t x = x0; x <= x1; ++x) {
                ...
                if (w0 >= 0 && w1 >= 0 && w2 >= 0) {
                    ...
                    if (z < depthBuffer[y * imageWidth + x]) {
                        ...
                        screen->drawPoint(glm::vec2(x,y), Color(nDotView * 255,nDotView * 255,nDotView * 255));
                    }
                }
            }
        }
